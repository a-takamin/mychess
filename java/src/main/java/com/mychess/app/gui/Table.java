...
import com.mychess.app.engine.player.MoveTransition;
...
public class Table {
  ...
  private static String defaultPieceImagePath = "src/main/resources/pieceicon/";
  ...
  private JMenu createPreferencesMenu() {
    ...
    final JCheckBoxMenuItem legalMoveHighlightCheckbox = new JCheckBoxMenuItem("Highslight Legal Moves", false);
  ...
  private class TilePanel extends JPanel {
    ...
    private void assignTilePieceIcon(final Board board) {
      ...
      if (board.getTile(this.tileId).isTileOccupied()) {
        final String pieceIconPath = defaultPieceImagePath;
        try {
          File iconFile = new File(
              pieceIconPath + board.getTile(tileId).getPiece().getPieceAlliance().toString().substring(0, 1)
